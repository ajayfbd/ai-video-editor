...
@click.option("--language", type=str, default=None, help="Language for audio transcription (auto-detect if omitted)")
@click.option("--model", type=str, default="large", help="Whisper model size for transcription (default: large for best quality)")
...
@click.option("--force-model", default=True, is_flag=True, help="Force use of specified model size even on CPU (default: enabled)")
